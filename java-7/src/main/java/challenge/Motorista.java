...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
        ...
        this.validaString(habilitacao, "habilitação");
    ...
    public String toString() {
        return  String.format("Motorista { nome = ", nome," '\'', idade=", idade," pontos=", pontos,", habilitacao=", habilitacao, " '\''}");
    }
    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withNome(String nome) {
            Motorista.validaString(nome, "nome");
            this.nome = nome;
            return this;
        }
